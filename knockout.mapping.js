(function(factory) {
    ...
    function updateViewModel(mappedRootObject, rootObject, options, parentName, parent, parentPropertyName, mappedParent, rawParent) {
            ...
            return withProxyDependentObservable(dependentObservables, function() {
                ...
                if (ko.utils.unwrapObservable(parent) instanceof Array) {
                    return options[parentName].create({
                        ...
                        rawParent: callbackParams.rawParent,
                        skip: emptyReturn
                    });
                }
                else {
        ...
        if (!isArray) {
            ...
            if (!canHaveProperties(rootObject)) {
                ...
                visitPropertiesOrArrayEntries(rootObject, function(indexer) {
                    ...
                    var retval = updateViewModel(mappedRootObject[indexer], rootObject[indexer], options, indexer, mappedRootObject, fullPropertyName, mappedRootObject, rootObject);
            ...
            for (i = 0, j = editScript.length; i < j; i++) {
                ...
                switch (key.status) {
                    case "added":
                        ...
                        mappedItem = updateViewModel(undefined, item, options, parentName, mappedRootObject, fullPropertyName, parent, rawParent);
                        if (!hasCreateCallback()) {
                    ...
                    case "retained":
                        ...
                        updateViewModel(mappedItem, item, options, parentName, mappedRootObject, fullPropertyName, parent, rawParent);
